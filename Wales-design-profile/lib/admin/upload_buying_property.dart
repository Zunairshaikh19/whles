...
class UploadBuyingProperty extends StatefulWidget {
  final String type;
  const UploadBuyingProperty(this.type, {super.key});

  @override
  State<UploadBuyingProperty> createState() => _UploadBuyingPropertyState();
}

class _UploadBuyingPropertyState extends State<UploadBuyingProperty> {
  ...
  bool checkCredentials() {
    ...
    } else if (shareAveragePriceController.text.isEmpty) {
      Constants.showMessage(context, "Please enter shares average price");
    } else if (shareSoldController.text.isEmpty) {
      Constants.showMessage(context, "Please enter sold shares");
    } else if (sharesLeftController.text.isEmpty) {
      Constants.showMessage(context, "Please enter shares left");
    } else if (averagePurchaseController.text.isEmpty) {
      Constants.showMessage(context, "Please enter average purchase");
    } else {
      result = true;
    }
    return result;
  ...
  //   if (user != null) {
  //     await FirebaseFirestore.instance
  //         .collection("UserPropertyMediaFiles")
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              CustomTextField(
                controller: shareAveragePriceController,
                prefixIcon: '',
                hintText: 'Share Average Price',
                hintTextColor: AppTheme.whiteColor,
              ),
              const SizedBox(
                height: 15,
              ...
              CustomTextField(
                controller: shareSoldController,
                prefixIcon: '',
                hintText: 'Shares Sold',
                hintTextColor: AppTheme.whiteColor,
              ),
              const SizedBox(
                height: 15,
              ...
              CustomTextField(
                controller: sharesLeftController,
                prefixIcon: '',
                hintText: 'Shares Left',
                hintTextColor: AppTheme.whiteColor,
              ),
              const SizedBox(
                height: 15,
              ...
              CustomTextField(
                controller: chargeInCashController,
                prefixIcon: '',
              ...
              CustomTextField(
                controller: averagePurchaseController,
                prefixIcon: '',
                hintText: 'Average Purchase',
                hintTextColor: AppTheme.whiteColor,
              ),
              const SizedBox(
                height: 15,
